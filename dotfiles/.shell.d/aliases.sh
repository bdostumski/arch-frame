...
alias clamscan-home-quarantine="clamscan -r --move=/home/${USER}/.config/.clamav/quarantine /home/${USER}/"
alias clamscan-root-quarantine="sudo clamscan -r --move=/home/${USER}/.config/.clamav/quarantine /"
